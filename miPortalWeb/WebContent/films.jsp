	...
	<div style="width: 70%; margin: 0 auto;">
		...
		<%
			for (j = 0; j < tablares[i].length; j++) {
					...
					String query2 = "Select ROUND(AVG(votacion),2) from valoraciones_peliculas join peliculas ON (valoraciones_peliculas.idPelicula=peliculas.idPelicula) WHERE peliculas.titulo LIKE '"
							+ tablares[i][j] + "' GROUP BY valoraciones_peliculas.idPelicula ;";
